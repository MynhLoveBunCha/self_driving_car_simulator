class NeuralNetwork
{
    constructor(neuron_counts)  //array of number of neuron in each layer
    {
        this.levels = [];
    ...
    static feedForward(given_inputs, network)
    {
        let outputs = Level.feedForward(given_inputs, network.levels[0]);  // take output from the first layer
...
class Level
{
    ...
    static feedForward(given_inputs, level)
    {
        for(let i = 0; i < level.inputs.length; i++)
        {
